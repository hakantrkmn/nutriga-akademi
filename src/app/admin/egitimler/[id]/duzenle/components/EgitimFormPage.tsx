        ...
        try {
          ...
          if (response.success && response.data) {
            ...
            setFormData({
              ...
              price: response.data.price || 299,
              category: response.data.category || 'Temel Beslenme',
              level: response.data.level || 'Başlangıç',
              duration: response.data.duration || '8 saat',
              instructor: response.data.instructor || 'Dr. Ahmet Yılmaz',
              salesCount: response.data.salesCount || 156
            })
