            ...
            <VStack align="start" gap={3} w="full">
              <Box>
                ...
                <Text color="gray.600" fontSize="sm">
                  Evet, tüm eğitimlerimiz online platform üzerinden canlı olarak gerçekleşmektedir.
                </Text>
              </Box>
              ...
              <Box>
                ...
                <Text color="gray.600" fontSize="sm">
                  Kayıt olduktan sonra size özel panel üzerinden tüm materyallere erişim sağlayabilirsiniz.
                </Text>
              </Box>
              ...
              <Box>
                ...
                <Text color="gray.600" fontSize="sm">
                  Tabii ki! Eğitim sonrası 30 gün boyunca ücretsiz destek hizmeti sunuyoruz.
                </Text>
              </Box>
            </VStack>
          </VStack>
