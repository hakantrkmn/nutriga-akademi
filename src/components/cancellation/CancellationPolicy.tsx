  ...
  return (
    <div className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6 space-y-16">
        ...
        {/* Cayma Formu Bilgilendirmesi */}
        <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            <div className="p-3 bg-blue-50 rounded-xl">
              <HiClipboardList className="w-8 h-8 text-blue-500" />
            </div>
            <h3 className="text-2xl font-bold text-gray-800">Cayma Formu</h3>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 rounded-lg p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                kapsamında, satın aldığınız eğitim hizmetinden cayma hakkınız
                bulunmaktadır.
              </p>
              <p className="text-gray-600 text-sm">
                Bu form, sadece sözleşmeden cayma hakkı kullanılmak
                istenildiğinde doldurulup gönderilecektir.
              </p>
            </div>

            <div className="space-y-4">
              <h4 className="text-lg font-semibold text-gray-800">
                Cayma Formunda Yer Alacak Bilgiler:
              </h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        İsim, unvan, adres, faks ve e-posta
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                    <div>
                      <p className="font-medium text-gray-800">Hizmet Bedeli</p>
                      <p className="text-sm text-gray-600">
                        Ödenen tutar bilgisi
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Tam isim bilgisi</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">İletişim adresi</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                    <div>
                      <p className="font-medium text-gray-800">İmza</p>
                      <p className="text-sm text-gray-600">
                        Kağıt üzerinde gönderilmesi halinde
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                    <div>
                      <p className="font-medium text-gray-800">Tarih</p>
                      <p className="text-sm text-gray-600">
                        Form doldurulma tarihi
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-yellow-800 text-sm">
                <strong>Not:</strong> Bu formla aşağıdaki malların satışına veya
                hizmetlerin sunulmasına ilişkin sözleşmeden cayma hakkınızı
                kullandığınızı beyan edersiniz.
              </p>
            </div>
          </div>
        </div>
